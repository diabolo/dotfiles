...
function! Post_syn_hl()    " {{{3
  :syntax clear
  :runtime! syntax/markdown.vim   " content syntax is html hl, except for headers
...
ruby <<EOF
  ...
  class Wp_vim
    ...
    def get_personal_data  
      @login = "andy" # insert your login here
      @passwd = "nKOC6XibRQELT0bNAIjSKhjyUPchEuYYNOJdqiNUCfanYbbalM" # insert your password here
      @site = "blog.andrew.premdas.org" # insert your blog url here, but do not use http://
      @xml = "/backend/xmlrpc" # change if necessary
